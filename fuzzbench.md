...
на основе полученных результатов сложно сделать вывод об эффективности afl++ по сравнению с afl. По результам 1 часового эксперимента в bloaty_fuzz_target afl++ показал себя хуже чем afl однако, как показывают отчеты и результаты 5 часового эксперимента, на большем промежутке afl++ выиграет. В libpng_libpng_read_fuzzer 
в точности наоборот. 
<br>
