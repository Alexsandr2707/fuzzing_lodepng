...
<pre style="display: inline-block; white-space: pre-wrap; background: #f6f8fa; padding: 10px; border-radius: 6px; margin: 10px 0; font-family: monospace; border: 1px solid #e1e4e8;">
